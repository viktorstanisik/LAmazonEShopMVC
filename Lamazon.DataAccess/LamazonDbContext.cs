...
namespace Lamazon.DataAccess
{
    public class LamazonDbContext : IdentityDbContext<User>
    {
        ...
        public void Seed(ModelBuilder modelBuilder)
        {
            ...
            string viktorUserId = Guid.NewGuid().ToString();
            ...
            modelBuilder.Entity<User>()
                .HasData(
                    ...
                    {
                        Id = viktorUserId,
                        FullName = "Viktor Stanisic",
                        UserName = "viktor.stanisic",
                        NormalizedUserName = "VIKTOR.STANISIC",
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order { Id = 1, DateOfOrder = DateTime.UtcNow, Status = StatusType.Init, UserId = viktorUserId },
                new Order { Id = 2, DateOfOrder = DateTime.UtcNow, Status = StatusType.Pending, UserId = viktorUserId }
           );
